        ...
        Try
            ...
            If (ds.Tables(0).Rows.Count > 0) Then
                ...
                ElseIf ds.Tables(0).Rows(0)("userGroup").ToString = "EmailCheck" Then
                    ...
                    Dim strSQL As String = "Select CM.client_name, CM.client_id, SUBSTRING(database_name,8,4) AS dbname, '2' as ListOrder , 'Surveymain.aspx' as hrefPage, CM.GUID as CGUID, UC.userRole" &
                ...
                Else
                    ...
                    strSQL = "Select CM.* from tbluserclient UC Inner Join client_master CM on UC.client_id = CM.client_id " &
                    ...
                    Else
                        ...
                        Dim strSQL1 As String = "Select CM.client_name, CM.client_id, SUBSTRING(database_name,8,4) AS dbname, '2' as ListOrder , 'Surveymain.aspx' as hrefPage, CM.GUID as CGUID, UC.userRole" &
                            " from tbluserclient UC Inner Join client_master CM on UC.client_id = CM.client_id " &
                            " where CM.Active = 1 and UC.Active = 1 and userid = " & Session("user_id") & " Order by ListOrder, client_name "
                        dt1 = db1.DataAdapter(CommandType.Text, strSQL1).Tables(0)
                        Session("user_group") = "User"
                        Session("client_id") = dt1.Rows(0)("client_id")
                        Session("dbname") = dt1.Rows(0)("dbname")
                        Session("CGUID") = dt1.Rows(0)("CGUID")
                        Session("userRole") = dt1.Rows(0)("userRole")
                        Response.Redirect("SurveyAssigned.aspx", True)
                    End If
                End If
            End If
